        ...
        SafeArea(
          child: Column(
            children: [
              ...
              // Story pages with tap navigation — native RTL Directionality
              // (inherited from MaterialApp) is correct: page 0 renders on
              // the right and animations slide in from the left, matching
              // Arabic reading flow.
              Expanded(
                child: GestureDetector(
                  onTapUp: _onTap,
