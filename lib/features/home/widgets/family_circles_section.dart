...
///
/// Uses [addressBookRelativesProvider] (not [viewerFilteredRelativesProvider])
/// so the home "\u0639\u0627\u0626\u0644\u062a\u0643" carousel shows EVERY relative the viewer is
/// connected to across all their groups + personal scope. Active-group
/// switching shouldn't make the viewer's original family disappear from
/// their "your family" carousel \u2014 that's the address-book mental model.
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return relativesAsync.when(
      ...
      error: (error, _) => InlineErrorWidget(
        ...
        onRetry: () => ref.invalidate(addressBookRelativesProvider),
      ),
    );
  }
}
