...
class BadgeConfig {
  ...
  static List<BadgeConfig> fallbackBadges() {
    return [
      ...
      BadgeConfig(badgeKey: 'variety_3', displayNameAr: 'منوع', descriptionAr: 'تواصل مع 3 أقارب مختلفين', emoji: '🎨', category: 'variety', thresholdType: 'unique_relatives', thresholdValue: 3, xpReward: 100, isSecret: false, sortOrder: 30),
      BadgeConfig(badgeKey: 'variety_10', displayNameAr: 'شبكة علاقات', descriptionAr: 'تواصل مع 10 أقارب مختلفين', emoji: '🌐', category: 'variety', thresholdType: 'unique_relatives', thresholdValue: 10, xpReward: 300, isSecret: false, sortOrder: 31),
