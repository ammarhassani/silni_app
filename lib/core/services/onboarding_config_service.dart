...
class OnboardingConfigService {
  ...
  static List<OnboardingScreenConfig> get _fallbackScreens => [
    ...
    OnboardingScreenConfig(
      ...
      screenOrder: 2,
      titleAr: 'كيف نناديك؟',
      titleEn: 'How should we address you?',
      subtitleAr: 'اختر الجنس لنُخصِّص لك التذكيرات والروابط بشكل صحيح',
      subtitleEn:
          'Pick gender so reminders and relations are correctly tailored',
      animationName: 'onboarding_gender',
      backgroundColor: '#FFFFFF',
      textColor: '#1F2937',
      buttonTextAr: 'التالي',
      buttonTextEn: 'Next',
