...
android {
    ...
    productFlavors {
        create("staging") {
            ...
            resValue("string", "app_name", "Silni (Staging)")
        }
        ...
        create("production") {
            ...
            resValue("string", "app_name", "Silni")
        }
    }
    ...
    buildTypes {
        release {
            ...
            // This allows development builds to work without a keystore
