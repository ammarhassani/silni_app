-- =====================================================
-- Fix Gamification Stats - badges is text[], not jsonb
-- =====================================================
...
BEGIN
  ...
  -- Build result with direct subqueries
  -- Note: badges is text[] not jsonb, so use array_length instead of jsonb_array_length
  SELECT json_build_object(
    ...
    'users_with_badges', (SELECT count(*) FROM users WHERE badges IS NOT NULL AND array_length(badges, 1) > 0),
