-- Re-seed admin_hadith and admin_quotes for production
-- The original seed (20251230200006) didn't apply correctly to production

-- First, ensure tables are empty to avoid duplicates
DELETE FROM admin_hadith WHERE true;
DELETE FROM admin_quotes WHERE true;
