-- RESTORE PROPER THEMES
-- The reseed migration accidentally replaced the proper themes with placeholder ones
-- This restores the original themes with full color/gradient data
